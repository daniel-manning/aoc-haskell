module Day19_2020
    ...
    readRulesAndMessages = (\x -> (map (fromRight' . parse parseIndexedRule "") $ head x, x !! 1)) . groupBetweenBlankLines . lines <$> readFile "resource/2020/day19"
